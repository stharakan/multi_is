...
filen=data.${BRAIN}.${FKEEP}.${STYPE}.${TARGET}.${FTYPE}.${PSSTR}.${PSP1}.${PSIZE}
...
matlab -r \"TstBrainDataCompute('${BDIR}','${BRAIN}','${OUTDIR}', '${PSSTR}', ${PSP1},${PSIZE},'${FTYPE}','${STYPE}', ${FKEEP},${TARGET} ); quit\"  
" > ${filen}.job
