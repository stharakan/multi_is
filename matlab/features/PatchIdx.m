function [ d3_idx,feat_idx ] = PatchIdx( psize,vert,horz,slc_per_brn,brns,lin_idx )
...
if nargin > 5
    feat_idx = repmat(lin_idx(:), 1,patch_vol);
    feat_idx = bsxfun(@plus,feat_idx,d3_idx);
