function [ GF ] = CreatePatchFeatures( brn_dir,sv_file,psize,varargin )
%CREATEGABORFEATURES essentially reads the brain files passed in varargin,
%which should be locaed in brn_dir. Then Patch features are computed, 1
...
%
% OUTPUT:
% GF: Patch feature matrix 
%
% ----- HOW TO USE  ----
%
% To create the Patch features for brnA, images in
...
%
% [ GF,nzidx ] = CreatePatchFeatures( brn_dir,sv_file,psize,brns );
% 
...
for bi = 1:brns
    ...
    % Patch for that brain, all mods
    GFsm = GetPatchFeatures( psize,flair,t1,t1ce,t2 );
