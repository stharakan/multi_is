...
if ~exist('whichbrains')
    ...
    brains = {brats17tst_brains{whichbrains}};
end
original_dir = brats17tst_original_dir;
classifier_dirs = {'./res_tst_dnn_wt/','./res_tst_lgbm_wt/','./res_tst_kde_wt/'};
...
for bidx=1:length(brains)
  ...
  hasgtr=~isempty(gtr); hasgtr=false;
  if hasgtr
