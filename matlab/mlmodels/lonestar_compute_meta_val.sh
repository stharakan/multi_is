#!/bin/bash
#SBATCH -J val-lgbm.out            # job name
#SBATCH -o val-lgbm.err        # output and error file name (%j expands to jobID)
...
matlab -r "meta_preprocess_func('val',1,1,1); quit"
python segment_brain.py 1 0 1 
matlab -r "meta_postprocess_func('val',1,1,1); quit"
