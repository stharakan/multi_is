function [ franks ] = FeatureRankerClassification( blist,ftype,psize,target,params,outdir )
...
% preprocess y 
num_classes = 4;
[~,~,yy] = BucketCounterNoEnds(ppvec,num_classes);
...
for ri = 1:runs
    % Run svmrfe
    [frank] = ftSel_SVMRFECBR_lin_cla(fmat,yy,params);
