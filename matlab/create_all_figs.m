...
for rank = ranks
    for ki = kas
        ...
        for bi = 1:length(brns)
            ...
            % plot dim 1 constant
            d1_fig = figure;
            line_plot_figure(1,tst_brn_idx,is_runs,ka_type,rank,batches)
            ...
            % dim 2
            d2_fig = figure;
            line_plot_figure(2,tst_brn_idx,is_runs,ka_type,rank,batches)
            ...
            % histograms
            hist_fig = figure;
            histogram_figure(tst_brn_idx, is_runs, ka_type,rank,batches);
...
%             figure(fmain);
%             main_figure(tst_brn_idx, is_runs, ka_type, rank, batches,ha((bi-1)*6 + (1:6)),extra_str);
%             savefig(fmain,['main_',basefilename,'.fig']);
%             print(['main_',basefilename,'.png'],'-dpng');
%             
%             % plot dim 1 constant
%             d1_fig = figure;
%             line_plot_figure(1,tst_brn_idx,is_runs,ka_type,rank,batches)
%             savefig(d1_fig,['d1_',basefilename,'.fig']);
%             print(['d1_',basefilename,'.png'],'-dpng');
%             
%             % dim 2
%             d2_fig = figure;
%             line_plot_figure(2,tst_brn_idx,is_runs,ka_type,rank,batches)
%             savefig(d2_fig,['d2_',basefilename,'.fig']);
%             print(['d2_',basefilename,'.png'],'-dpng');
%         end
%     end
% end
